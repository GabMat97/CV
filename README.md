...
References available upon request..com/CelineKaslin/Codagram)|Final project at Makers where we decided to build a learning platform where kids can learn the basics of different programming languages|Python, Flask, SQLAlchemy, HTML5, CSS, Bootstrap|Unittest, Travis CI                |
